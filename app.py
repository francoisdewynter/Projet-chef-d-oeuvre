...
def create_resultstable():
   # c.execute('PRAGMA foreign_keys = ON')
    c.execute('CREATE TABLE IF NOT EXISTS results(Id INTEGER PRIMARY KEY, username TEXT, predictions REAL, FOREIGN KEY(Id) REFERENCES users(id))')
    conn.commit()
    ...
    if st.sidebar.checkbox('Login'):
        ...
        if result:
            ...
            if task == 'Zirconia database':
                ...
                carat= st.slider('Carat', min_value=0.8, max_value=5.0)
